...
<script type="text/javascript" src="${firstPage.cdnChartJs}"></script>
<script>
var backgroundColor = ['rgba(255, 99, 132, 0.5)', 'rgba(54, 162, 235, 0.5)', 'rgba(75, 192, 192, 0.5)', 'rgba(153, 102, 255, 0.5)', 'rgba(255, 159, 64, 0.5)'];
var borderColor = ['rgba(255,99,132,1)', 'rgba(54, 162, 235, 1)', 'rgba(75, 192, 192, 1)', 'rgba(153, 102, 255, 1)', 'rgba(255, 159, 64, 1)'];
var layout = {padding: {left: 0, right: 0, top: 20, bottom: 20}};
...
(function () {
    $.post("ip/chartStatic", {}, function (data) {
        init(data);
    });
})();
