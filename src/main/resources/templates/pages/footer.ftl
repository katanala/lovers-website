    ...
    <div class="container">
        <div class="row footer-top">
            ...
            <div class="text-center" style="margin-bottom: 2rem;">
                友情链接：
                <#list firstPage.links as link>
                    <a target="_blank" href="${link.href}">${link.title}</a>
                </#list>
            </div>

            <div class="text-center">
                <a target="_blank" href="http://www.beian.miit.gov.cn/">鲁ICP备17015825号</a> &nbsp; | &nbsp;
                <img src="/image/beiantubiao.png"/>
                <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=37150202000281">鲁公网安备
                    37150202000281号</a>
            </div>
